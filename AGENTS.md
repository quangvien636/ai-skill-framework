...
This file exists so agent tools that auto-load a root `AGENTS.md` (Codex
CLI and similar) get repository orientation at session start, matching
what `CLAUDE.md` provides for Claude Code.
