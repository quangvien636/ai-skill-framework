...
SEMANTIC_RUNTIME_MODEL_MISSING = "ASF-SEMANTIC-010"
SEMANTIC_RUNTIME_RETRIEVER_MISSING = "ASF-SEMANTIC-011"
SEMANTIC_RUNTIME_TOOLS_MISSING = "ASF-SEMANTIC-012"
SEMANTIC_RUNTIME_PUBLISHER_INVALID = "ASF-SEMANTIC-013"
SEMANTIC_RUNTIME_RETRY_POLICY_INCOMPATIBLE = "ASF-SEMANTIC-014"
SEMANTIC_RUNTIME_TIMEOUT_PROFILE_INVALID = "ASF-SEMANTIC-015"
SEMANTIC_RUNTIME_FALLBACK_CHAIN_INVALID = "ASF-SEMANTIC-016"

# ASF-BINDING-* code allocations (ADR-0015). These run over a resolved
# RuntimeBinding/BindingIR -- fallback-chain resolution outcomes, not
# single-artifact IR checks (ASF-SEMANTIC-*) or repository-layout checks
# (ASF-REPOSITORY-*).
BINDING_MISSING_RUNTIME = "ASF-BINDING-001"
BINDING_CYCLIC_FALLBACK = "ASF-BINDING-002"
BINDING_UNRESOLVED_CHAIN = "ASF-BINDING-003"
BINDING_INVALID_INHERITANCE = "ASF-BINDING-004"
BINDING_DUPLICATE_ID = "ASF-BINDING-005"
BINDING_INCOMPATIBLE_DESCRIPTORS = "ASF-BINDING-006"
BINDING_CONFLICTING_OVERRIDE = "ASF-BINDING-007"
...
REPOSITORY_ADR_STATUS_INVALID = "ASF-REPOSITORY-014"
